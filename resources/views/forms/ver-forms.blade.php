...
@section('content')
    ...
    <form action="{{ route('save.forms') }}" method="POST">
    @csrf
    <div class="form-container">
        <div class="form-section">
            <h3>SOLICITUD DE FORMACION BE CALL</h3>
            ...
            <div class="form-group">
                ...
                <div class="radio-group">
                    <input type="radio" id="tipo_{{ $tipo->id }}" name="id_tipo_formacion" value="{{ $tipo->id }}" required>
            ...
            <div class="form-group">
                ...
                <textarea name="detalle_formacion" id="detalle_formacion"></textarea>
            </div>
            <div class="form-group">
                ...
                <textarea name="formacion_inicial" id="formacion_inicial"></textarea>
            </div>
            <div class="form-group">
        ...
        <div class="form-group">
            <button type="submit" class="submit-btn">Solicitar Formacion</button>
        </div>
    </div>
</form>
@endsection
