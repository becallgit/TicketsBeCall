...
@section('content')
    ...
    <div class="container">
        <h2 style="text-align:center;">Peticiones Realizadas</h2>
        <form method="GET" action="{{ route('ver.peticiones') }}">
    <div class="filter-container">
        ...
        <a href="{{ route('ver.peticiones') }}"><i class="fa-solid fa-eraser"></i> Limpiar</a>
    </div>
</form>
                    ...
                    <tr>
                        ...
                        @if($ticket->estado == "Pausado")
                          ...
                          @endif
                            ...
                            <a href="{{ route('ticket.mostrado', $ticket->id) }}" class="icono" title="Ver Ticket"><i class="fa-solid fa-eye"></i></a>
                        </td>
        ...
        @if ($tickets->isEmpty())
            <p class="notickets">No has solicitado ningun ticket todavía.</p>
        @endif
    </div>
